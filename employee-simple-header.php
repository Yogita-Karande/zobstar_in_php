            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="menu-full-width">
                        <div class="logo">
                            <a href="<?= base_url; ?>index.php"><img src="<?= image_path; ?>logo.png" style="width:50%" alt="logo"></a>
                        </div><!-- end logo -->                       
                                    ...
                                    <div class="notification-item">
                                        <div class="dropdown">
                                            <button class="notification-btn dot-status online-status dropdown-toggle" type="button" id="userDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <img src="<?= image_path; ?>company-logo.jpg" alt="Bluetech,Inc">
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="userDropdownMenu">
                                                <div class="mess-dropdown">
                                                    ...
                                                    <div class="mess__body">
                                                        <ul class="list-items">
                                                            <li class="mb-0">
                                                            <a href="<?= base_url; ?>employee/employer-dashboard.php" class="d-block">
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="<?= base_url; ?>eindex.php" class="d-block">
                ...
                <div class="tab-pane fade show active" id="notification-home" role="tabpanel" aria-labelledby="notification-tab">
                    <div class="user-sidebar-item">
                        <div class="mess-dropdown">
                            ...
                            <div class="mess__body">
                                <a href="<?= base_url;?>employee/employer-dashboard-sidebar.php" class="d-block">
                                    <i class="la la-user"></i> Account
                                </a>
                                <a href="<?= base_url;?>employee/employer-dashboard-sidebar.php" class="d-block">
                                    <i class="la la-plus"></i> Post a Job

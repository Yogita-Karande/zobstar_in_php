...
<?php
require_once('employee/employee-dashboard-sidebar.php')
?>
                    ...
                    <div class="billing-form-item">
                        ...
                        <div class="billing-content pb-0">
                            <div class="manage-candidate-wrap d-flex align-items-center justify-content-between pb-4">
                                <div class="bread-details d-flex">
                                    <div class="bread-img flex-shrink-0">
                                        <a href="<?= base_url?>candidate/candidate-profile.php" class="d-block">
                                            <img src="<?= image_path?>small-team1.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="manage-candidate-content">
                                        <h2 class="widget-title pb-2"><a href="candidate/candidate-profile.php" class="color-text-2">David Johnston</a></h2>
                            ...
                            <div class="manage-candidate-wrap d-flex align-items-center justify-content-between pb-4 pt-4">
                                <div class="bread-details d-flex">
                                    <div class="bread-img flex-shrink-0">
                                        <a href="candidate/candidate-profile.php" class="d-block">
                                            <img src="<?= image_path?>small-team2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="manage-candidate-content">
                                        <h2 class="widget-title pb-2"><a href="candidate/candidate-profile.php" class="color-text-2">David Ortega</a></h2>
                                        <p class="font-size-15">
                            ...
                            <div class="manage-candidate-wrap d-flex align-items-center justify-content-between pb-4 pt-4">
                                <div class="bread-details d-flex">
                                    ...
                                    <div class="manage-candidate-content">
                                        <h2 class="widget-title pb-2"><a href="candidate/candidate-profile.php" class="color-text-2">Johnathan Doe</a></h2>
                                        <p class="font-size-15">
                            ...
                            <div class="manage-candidate-wrap d-flex align-items-center justify-content-between pb-4 pt-4">
                                <div class="bread-details d-flex">
                                    ...
                                    <div class="manage-candidate-content">
                                        <h2 class="widget-title pb-2"><a href="candidate/candidate-profile.php" class="color-text-2">Albert Dua</a></h2>
                                        <p class="font-size-15">

...
<section class="card-area padding-top-100px padding-bottom-80px">
                                  ...
                                  <div class="job-card-details d-flex align-items-center justify-content-between">
                                      <div class="card-head d-flex align-items-center">
                                          ...
                                          <div class="company-title-box">
                                              <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php">IT Care Software LTD </a> </h4>
                                              <p class="card-sub">
                                      ...
                                      <div class="btn-box">
                                          <a href="<?= base_url?>job-details.php" class="theme-btn">4 Open Jobs</a>
                                      </div>
                                  </div>
                              </div><!-- end job-card -->
                              <div class="job-card job-card-layout">
                                  <div class="job-card-details d-flex align-items-center justify-content-between">
                                      <div class="card-head d-flex align-items-center">
                                          ...
                                          <div class="company-title-box">
                                              <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php"> Healthyeat Company</a> </h4>
                                              <p class="card-sub">
                              ...
                              <div class="job-card job-card-layout">
                                  <div class="job-card-details d-flex align-items-center justify-content-between">
                                      <div class="card-head d-flex align-items-center">
                                          ...
                                          <div class="company-title-box">
                                              <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php">Digoin Creative LTD </a> </h4>
                                              <p class="card-sub">
                              ...
                              <div class="job-card job-card-layout">
                                  <div class="job-card-details d-flex align-items-center justify-content-between">
                                      <div class="card-head d-flex align-items-center">
                                          ...
                                          <div class="company-title-box">
                                              <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php">Homolant Real Estate </a> </h4>
                                              <p class="card-sub">
                                                  <span class="mr-2"><i class="la la-briefcase color-text-2 mr-1"></i>Real Estate</span>
	...
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z"/>
                                          ...
                                          <div class="company-title-box">
                                              <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php">Doitco Bank </a> </h4>
                                              <p class="card-sub">
                              ...
                              <div class="job-card job-card-layout">
                                  <div class="job-card-details d-flex align-items-center justify-content-between">
                                      <div class="card-head d-flex align-items-center">
                                          ...
                                          <div class="company-title-box">
                                              <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php"> TeraPlaner</a> </h4>
                                              <p class="card-sub">
                              ...
                              <div class="job-card job-card-layout">
                                  <div class="job-card-details d-flex align-items-center justify-content-between">
                                      <div class="card-head d-flex align-items-center">
                                          ...
                                          <div class="company-title-box">
                                              <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php">King LLC </a> </h4>
                                              <p class="card-sub">
                                      ...
                                      <div class="job-card">
                                          <div class="job-card-content">
                                              <div class="card-head d-flex align-items-center">
                                                  ...
                                                  <div class="company-title-box">
                                                      <h4 class="card-title mb-1"><a href="<?= base_url?>employee/employer-profile.php">RevoTheme </a> </h4>
                                                      <p class="card-sub">
                                                          <span class="mr-2"><i class="la la-briefcase color-text-2 mr-1"></i>Human Resources</span>
                                                          <span class="mr-2"><i class="la la-map-marker color-text-2 mr-1"></i>Toronto, Ontario</span>
                                                      </p>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="post-card section-bg pb-5 pr-4 pl-4 pt-4">
                    <div class="post-card-content">
                        <img src="<?= image_path; ?>search.svg" alt="" class="img-fluid">
                    ...
                    <div class="btn-box mt-4 text-center">
                        <a href="<?= base_url?>employee/job-listing.php" class="theme-btn">Find a Job</a>
                    </div><!-- end btn-box -->
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column">
                <div class="post-card section-bg pb-5 pr-4 pl-4 pt-4">
                    <div class="post-card-content">
                        <img src="<?= image_path; ?>podcast.svg" alt="" class="img-fluid">
                    ...
                    <div class="btn-box mt-4 text-center">
                        <a href="<?= base_url?>employee/employer-job-post.php" class="theme-btn">Post a Job</a>
                    </div><!-- end btn-box -->
                </div>
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column">
                <div class="post-card section-bg pb-5 pr-4 pl-4 pt-4">
                    <div class="post-card-content">
                        <img src="<?= image_path; ?>data-points.svg" alt="" class="img-fluid">
                    ...
                    <div class="btn-box mt-4 text-center">
                        <a href="<?= base_url?>employee/employer-job-post.php" class="theme-btn">Get Data</a>
                    </div><!-- end btn-box -->
                </div>
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
        ...
        <div class="row">
            <div class="col-lg-4 responsive-column">
                <div class="footer-item">
                    <div class="logo">
                        <a href="<?= base_url?>index.php" class="foot-logo"><img src="<?= image_path; ?>logo2.png" alt="logo"></a>
            ...
            <div class="col-lg-2 responsive-column">
                <div class="footer-item">
                    ...
                    <ul class="list-items">
                        <li><a href="<?= base_url?>about.php">About / Press</a></li>

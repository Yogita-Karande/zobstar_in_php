                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="manage-candidate-wrap">
                                                        <h2 class="widget-title pb-1"><a href="<?= base_url?>job-profile.php" class="color-text-2">Land Development Marketer</a></h2>
                                                        <p>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="manage-candidate-wrap">
                                                        <h2 class="widget-title pb-1"><a href="<?= base_url?>job-details.php" class="color-text-2">Regional Sales Manager South</a></h2>
                                                        <p>
                                                            <span><i class="la la-clock-o font-size-16"></i> Last Update: Jan 21, 2020 </span>
                                                        </p>
                                                    </div><!-- end manage-candidate-wrap -->
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="manage-candidate-wrap">
                                                        <h2 class="widget-title pb-1"><a href="job-details.php" class="color-text-2">Node.js Developer</a></h2>
                                                        <p>
                                                            <span><i class="la la-clock-o font-size-16"></i> Last Update: Jan 21, 2020 </span>
                                                        </p>
                                                    </div><!-- end manage-candidate-wrap -->
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="manage-candidate-wrap">
                                                        <h2 class="widget-title pb-1"><a href="job-details.php" class="color-text-2">Graphic Design</a></h2>
                                                        <p>
                                                            <span><i class="la la-clock-o font-size-16"></i> Last Update: Jan 21, 2020 </span>
                                                        </p>
                                                    </div><!-- end manage-candidate-wrap -->

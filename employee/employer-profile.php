                    ...
                    <div class="breadcrumb-content d-flex flex-wrap justify-content-between align-items-center text-left">
                        <div class="bread-details d-flex align-items-center">
                            ...
                            <div class="employer-content">
                                <h2 class="widget-title font-size-30 text-white pb-1">Bluetech, Inc</h2>
                                <p class="font-size-16 mt-1 text-white">
                                    <span class="mr-2"><i class="la la-map-marker mr-1"></i> Aberdeen, United Kingdom</span>
                                ...
                                <p class="mt-2 font-size-15">
                                    <span class="text-white badge p-2 btn-rgb mr-1">IT Contractor</span>
                                    <span><a href="#" class="text-white mr-1">320 Reviews</a></span>
                                    <span>/</span>
                                    <span><a href="#" class="text-white ml-1">Visit Website</a></span>
                                </p>
                        ...
                        <div class="bread-action">
                            <ul class="listing-info">
                                <!-- <li>
                                    <button type="button" class="theme-btn mr-1"><i class="la la-bookmark font-size-16"></i> Bookmark</button>
                                </li> -->
                                <li>
                                    <button type="button" class="theme-btn border-0"><i class="la la-user font-size-16"></i> Follow</button>
                                </li>
                            </ul>
                            <p class="text-white font-size-13 mt-1">Get weekly updates, new jobs, and reviews</p>
                ...
                <div class="single-employer-wrap">
                    <div class="employer-description padding-bottom-35px">
                        <div class="section-heading">
                            <h2 class="sec__title font-size-24 line-height-35">Bluetech, Inc Careers and Employment</h2>
                        </div>
                    ...
                    <div class="video-employer padding-bottom-40px">
                        <h2 class="widget-title">Video</h2>
                        <div class="title-shape"></div>
                        <div class="video__box margin-top-35px text-center">
                            <img src="<?= image_path ?>img11.jpg" alt="video-image">
                    ...
                    <div class="user-action-card radius-round section-bg p-5 d-flex align-items-center justify-content-between">
                        <div class="user-action-heading">
                            <h2 class="widget-title pb-2">What would you say about your employer?</h2>
                            <p>Help fellow job seekers by sharing your unique experience.</p>
                        </div><!-- end user-action-heading -->
                        <div class="btn-box">
                            <a href="#" class="theme-btn">Write a Review</a>
                        </div><!-- end btn-box -->
                    </div><!-- end user-action-card -->
                    <div class="employer-job-post padding-top-40px">
                        <h2 class="widget-title">What jobs are available at Bluetech, Inc?</h2>
                        <div class="title-shape"></div>
                                ...
                                <div class="job-card-details d-flex align-items-center justify-content-between">
                                    <div class="card-head d-flex align-items-center">
                                        ...
                                        <div class="company-title-box">
                                            ...
                                            <h4 class="card-title mb-1"><a href="<?= base_url?>job-profile.php">Restaurant Assistant Manager </a> </h4>
                                            <p class="card-sub">
                                                <span class="mr-2"><i class="la la-building-o color-text-2"></i> BlueTech</span>
                                                <span class="mr-2"><i class="la la-map-marker color-text-2"></i> Aberdeen, United Kingdom</span>
                                                <span class="mr-2"><i class="la la-clock-o color-text-2"></i> Full Time</span>
                                    ...
                                    <div class="btn-box">
                                        <a href="<?= base_url?>job-profile.php" class="theme-btn">Apply Now</a>
                                    </div>
                                </div>
                            </div><!-- end job-card -->
                        </div><!-- end job-content -->
                    </div><!-- end employer-job-post-->
                    <div class="section-block mt-5"></div>
                    <div class="candidates-interview padding-top-35px">
                        <h2 class="widget-title">What did candidates say about the interview at Bluetech, Inc?</h2>
                        <div class="title-shape"></div>
                        <div class="feedback-card-box text-center">
                            <div class="row margin-top-35px">
                                <div class="col-lg-4 column-lg-half column-sd-full">
                                    <div class="icon-box feedback-card">
                                        <div class="icon-element"><i class="la la-thumbs-up"></i></div><!-- end icon-element-->
                                        <div class="info-content mt-3">
                                            <h4 class="info__title font-size-16 font-weight-bold mb-3">Favorable</h4>
                                            <h4 class="info__title font-size-13 mb-1">Interview experience</h4>
                                            <p class="info__desc font-size-13">Based on 12 interviews</p>
                                        </div><!-- end info-content -->
                                    </div><!-- end icon-box -->
                                </div><!-- end col-lg-4 -->
                                <div class="col-lg-4 column-lg-half column-sd-full">
                                    <div class="icon-box feedback-card">
                                        <div class="icon-element"><i class="la la-check"></i></div><!-- end icon-element-->
                                        <div class="info-content mt-3">
                                            <h4 class="info__title font-size-16 font-weight-bold mb-3">Easy</h4>
                                            <h4 class="info__title font-size-13 mb-1">Interview difficulty</h4>
                                            <p class="info__desc font-size-13">Based on 12 interviews</p>
                                        </div><!-- end info-content -->
                                    </div><!-- end icon-box -->
                                </div><!-- end col-lg-4 -->
                                <div class="col-lg-4 column-lg-half column-sd-full">
                                    <div class="icon-box feedback-card">
                                        <div class="icon-element"><i class="la la-bullhorn"></i></div><!-- end icon-element-->
                                        <div class="info-content mt-3">
                                            <h4 class="info__title font-size-16 font-weight-bold mb-3">About a day or two</h4>
                                            <h4 class="info__title font-size-13 mb-1">Interview process length</h4>
                                            <p class="info__desc font-size-13">Based on 8 interviews</p>
                                        </div><!-- end info-content -->
                                    </div><!-- end icon-box -->
                                </div><!-- end col-lg-4 -->
                            </div><!-- end row -->
                        </div><!-- end feedback-card-box -->
                    </div><!-- end candidates-interview -->
                                ...
                                <div class="info-list static-info">
                                    <ul>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-map-marker"></i> <span class="color-text-2 font-weight-medium mr-1">Headquarters:</span> Aberdeen, United Kingdom</p>
                                        </li>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-users"></i> <span class="color-text-2 font-weight-medium mr-1">Employees:</span> 10,200</p>
                                        </li>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-briefcase"></i> <span class="color-text-2 font-weight-medium mr-1">Industry:</span> IT Contractor</p>
                                        </li>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-envelope-o"></i> <span class="color-text-2 font-weight-medium mr-1">Email:</span><a href="#">bluetech@gmail.com</a> </p>
                                        </li>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-eye"></i> <span class="color-text-2 font-weight-medium mr-1">Viewed:</span> 1320</p>
                                        </li>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-file-text-o"></i> <span class="color-text-2 font-weight-medium mr-1">Posted Jobs:</span> 12</p>
                                        </li>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-clock-o"></i> <span class="color-text-2 font-weight-medium mr-1">Founded in:</span> 1998</p>
                                        </li>
                                        <li class="mb-3 d-flex align-items-center">
                                            <p><i class="la la-user"></i> <span class="color-text-2 font-weight-medium mr-1">Followers:</span> 1.2K</p>
                                        </li>
                                        <li class="d-flex align-items-center">
                                            <p><i class="la la-globe"></i> <span class="color-text-2 font-weight-medium mr-1">Website:</span><a href="#"> www.tehcydevs.com</a></p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="billing-content">
                                <div class="contact-form-action">
                                    <form method="post">
                                        ...
                                        <div class="btn-box">
                                            <button class="theme-btn border-0 w-100 text-center">Submit Message</button>

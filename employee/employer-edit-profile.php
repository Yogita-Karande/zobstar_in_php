                    ...
                    <div class="user-profile-action-wrap mb-5">
                        <div class="user-profile-action mb-4 d-flex align-items-center">
                            <div class="user-pro-img">
                                <img src="<?= image_path; ?>company-logo.jpg" alt="user-image" class="img-fluid radius-round border">
                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group user-chosen-select-container">
                                                            <select class="user-chosen-select" multiple>
                                                                <option selected="selected">IT Contractor</option>
                                                                ...
                                                                <option>Motoring & Automotive</option>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea class="message-control form-control pt-3 pr-4 pb-3 pl-4" name="message">Nemo ucxqui officia voluptatem accu santium doloremque laudantium, totam rem ape dicta sunt dose explicabo. Nemo enim ipsam voluptatem quia voluptas. Excepteur sint occaecat cupidatat non proident, sunt in culpa kequi officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusan tium dolorem que laudantium, totam rem aperiam the eaque ipsa quae abillo was inventore veritatis keret quasi aperiam architecto beatae vitae dicta sunt explicabo. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation. Curabitur non nulla sit amet nisl tempus</textarea>
                                                        </div>
                                                    </div><!-- end input-box -->
                                                </div><!-- end col-lg-12 -->
                                                <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="text" placeholder="www.facebook.com/bluetechinc">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-4 -->
                                            <div class="col-lg-4">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="text" placeholder="www.twitter.com/bluetechinc">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-4 -->
                                            <div class="col-lg-4">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="text" placeholder="www.instagram.com/bluetech_inc">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-4 -->
                                            <div class="col-lg-4">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="text" placeholder="www.Linkedin.com/bluetechinc">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-4 -->
                                            <div class="col-lg-4">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="text" placeholder="www.google-plus.com/bluetechinc">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-4 -->
                                            <div class="col-lg-4">
                                                <div class="input-box">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="text" placeholder="www.pinterest.com/bluetechinc">
                                                    </div>
                                                </div>
                                            </div><!-- end col-lg-4 -->
                                        </div><!-- end row -->

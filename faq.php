                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content text-center">
                        <div class="section-heading mb-3">
                            <h2 class="sec__title">Hello, How can we help?</h2>
                                    ...
                                    <div class="col-lg-7 mx-auto">
                                        <div class="input-box">
                                            <div class="form-group mb-0">
                                                <button type="button" class="theme-btn submit-btn border-0"><span class="fa fa-search"></span></button>
                                                <input class="form-control" type="text" name="name" placeholder="Search your question here...">
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-7 -->
                                </div><!-- end row -->
...
<!-- ================================
    START HIW AREA
================================= -->
<section class="hiw-area section-bg padding-top-80px padding-bottom-50px after-none text-center">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                        <div class="cat-content">
                            <svg class="cat-svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                <g>
                                    <g>
                            ...
                            <h4 class="cat__title mt-2">Getting Started</h4>
                        </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                        <div class="cat-content">
                            <svg class="cat-svg" version="1.1" id="Capa_3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
                            <g>
                                <g>
                            ...
                            <h4 class="cat__title mt-2">Pricing Plans</h4>
                        </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                       <div class="cat-content">
                           <svg class="cat-svg" version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
                           ...
                           <h4 class="cat__title mt-2">Salary</h4>
                       </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                        <div class="cat-content">
                            <svg class="cat-svg" version="1.1" id="Capa_4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 412.72 412.72" style="enable-background:new 0 0 412.72 412.72;" xml:space="preserve">
                            <g>
                                <g>
                            ...
                            <h4 class="cat__title mt-2">Usage Guides</h4>
                        </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                        <div class="cat-content">
                            <svg class="cat-svg" id="Capa_5" enable-background="new 0 0 511.996 511.996" viewBox="0 0 511.996 511.996" xmlns="http://www.w3.org/2000/svg">
                                <g id="XMLID_1609_">
                                    <g id="XMLID_564_">
                                        ...
                                        <path id="XMLID_1039_" d="m211.13 149.4c2.63 0 5.21-1.07 7.07-2.93s2.93-4.44 2.93-7.07-1.07-5.21-2.93-7.07c-1.86-1.859-4.43-2.93-7.07-2.93-2.63 0-5.21 1.07-7.07 2.93s-2.93 4.44-2.93 7.07 1.07 5.21 2.93 7.07c1.86 1.859 4.44 2.93 7.07 2.93z"/>
                                    </g>
                                </g>
                            </svg>
                            <h4 class="cat__title mt-2">Information</h4>
                        </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                        <div class="cat-content">
                            <svg class="cat-svg" version="1.1" id="Capa_6" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 480.1 480.1" style="enable-background:new 0 0 480.1 480.1;" xml:space="preserve">
                                <g>
                                    <g>
                            ...
                            <h4 class="cat__title mt-2">Transactions</h4>
                        </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                       <div class="cat-content">
                           <svg class="cat-svg" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 507.996 507.996" style="enable-background:new 0 0 507.996 507.996;" xml:space="preserve">
                            <g>
                                <g>
                           ...
                           <h4 class="cat__title mt-2">Card</h4>
                       </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="category-item faq-cat-item p-0">
                    <a href="#" class="d-block p-4">
                        <div class="cat-content">
                            <svg class="cat-svg" version="1.1" id="Capa_8" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 511.997 511.997" xml:space="preserve">
                            <g>
                                <g>
                            ...
                            <h4 class="cat__title mt-2">Account</h4>
                        </div>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
...
<!-- ================================
    START FAQ AREA
================================= -->
<section class="faq-area padding-top-100px padding-bottom-100px">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    <h2 class="sec__title font-size-30 mb-2">Zobstar Faqs</h2>
                    <p class="sec__desc font-size-16 line-height-26">
                        These are the most frequently asked questions we get about how to use Zobstar.
                        If you still have questions, you can find us on <a href="#" class="color-text">Facebook</a>,
                        <a href="#" class="color-text">Twitter</a>, <a href="#" class="color-text">Instagram</a> and
                        <a href="#" class="color-text">Google Plus</a> there are even <a href="#" class="color-text">more tips on finding and applying to jobs here</a>
                    </p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
        <div class="row margin-top-35px">
            <div class="col-lg-8">
                <div class="accordion accordion-item pr-4" id="accordionExample">
                    <div class="card">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTwo">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                   <span>Can I create a free Zobstar Account?</span>
                                    <i class="la la-minus"></i>
                                    <i class="la la-plus"></i>
                                </button>
                            </h2>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingThree">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    <span>How much time does it take to get approval?</span>
                                    <i class="la la-minus"></i>
                                    <i class="la la-plus"></i>
                                </button>
                            </h2>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingFour">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                    <span>Do I have to commit to a yearly subscription?</span>
                                    <i class="la la-minus"></i>
                                    <i class="la la-plus"></i>
                                </button>
                            </h2>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingFive">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingSeven">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingEight">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                    <span>What is Job board site?</span>
                                    <i class="la la-minus"></i>
                                    <i class="la la-plus"></i>
                                </button>
                            </h2>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingNine">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                    <span>Why people chose this Job board site?</span>
                                    <i class="la la-minus"></i>
                                    <i class="la la-plus"></i>
                                </button>
                            </h2>
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTen">
                            <h2 class="mb-0">
                                <button class="btn btn-link d-flex align-items-center justify-content-between" type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                                    <span>How do I find and apply for a job?</span>
                                    <i class="la la-minus"></i>
                                    <i class="la la-plus"></i>
                                </button>
                            </h2>
                ...
                <div class="faq-forum">
                    <div class="billing-form-item">
                        <div class="billing-title-wrap">
                            <h3 class="widget-title pb-0">Still have question?</h3>
        ...
        <div class="row mt-5">
            <div class="col-lg-4 responsive-column">
                <div class="post-card section-bg pb-5 pr-4 pl-4 pt-4">
                    ...
                    <div class="btn-box mt-4 text-center">
                        <a href="<?= base_url?>employee/employer-listing.php" class="theme-btn">Find a Job</a>
                    </div>
                    <!-- end btn-box -->
                </div>
            </div><!-- end col-lg-4 -->
            ...
            <div class="col-lg-4 responsive-column">
                <div class="post-card section-bg pb-5 pr-4 pl-4 pt-4">
                    ...
                    <div class="btn-box mt-4 text-center">
                        <a href="employee/employer-post-job.php" class="theme-btn">Get Data</a>
                    </div><!-- end btn-box -->
                </div>
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
